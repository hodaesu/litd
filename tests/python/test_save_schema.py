...
SCHEMA_KEYS={'version','gold','essence','light','supplies','party','expedition_room','equipment'}
...
def test_save_payload_ranges(gold,essence,light,supplies):
    payload={'version':'0.15','gold':gold,'essence':essence,'light':light,'supplies':supplies,'party':[],'expedition_room':0,'equipment':{}}
