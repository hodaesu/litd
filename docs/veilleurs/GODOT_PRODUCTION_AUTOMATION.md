...
4. audits Veilleurs v0.6 → v0.9 présents dans le dépôt ;
5. import Godot 4.3 strict ;
6. smoke Wave 3 ;
7. scène QA six donjons ;
8. régression tactile mobile ;
9. régression du parcours UI joueur.
...
1. Un identifiant canonique stable et en minuscules `snake_case`.
...
L'activation de l'addon est une opération d'éditeur à faire une fois sur le poste de travail : **Project > Project Settings > Plugins > Veilleurs Production Pipeline > Enable**.
...
- safe areas réelles ;
- haptique ;
- rendu GPU et performance sur appareils cibles ;
