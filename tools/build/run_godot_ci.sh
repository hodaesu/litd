...
run_checked "Les Veilleurs après reddition : survivants, informateurs, rancune et réputation de faction" timeout 90s godot --headless --path . res://scenes/tests/veilleurs_surrender_afterlife_smoke.tscn
