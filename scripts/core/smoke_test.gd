...
func _initialize() -> void:
    ...
    var required_files := [
        ...
        "res://data/equipment_rarities.json",
        "res://data/equipment_affixes.json",
        "res://data/capturable_creatures.json",
        ...
        "res://data/levels/ashlands_pacing_targets.json",
        "res://data/levels/ashlands_blender_jobs.json",
