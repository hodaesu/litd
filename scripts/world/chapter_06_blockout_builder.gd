extends Node3D
class_name Chapter06BlockoutBuilder
...
const SIGNAL_SCRIPT := preload("res://scripts/world/chapter_06_signal.gd")
const NODE_SCRIPT := preload("res://scripts/world/chapter_06_resonance_node.gd")

@export var zone_id := "c06_timeless_garden"
