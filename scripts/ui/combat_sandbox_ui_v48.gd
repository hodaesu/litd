extends "res://scripts/ui/combat_sandbox_ui_v47.gd"

# Combat Sandbox mobile avancé : formation R1-R4, contrôles temporisés,
# synergies contextuelles et charges d'ultime.
