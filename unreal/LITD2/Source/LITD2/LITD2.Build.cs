...
public class LITD2 : ModuleRules
{
    public LITD2(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        RuntimeDependencies.Add("$(ProjectDir)/Data/Combat/animation_combat_contracts.json");
        RuntimeDependencies.Add("$(ProjectDir)/Data/Combat/enemy_runtime_registry.json");
    }
}
